...
import PasswordChangedForm from './components/PasswordChangedForm';
          ...
          <div>
            {activeTab === 'Preview' && (
              <div className='black-grid-embed'>
                  <PasswordChangedForm mode={darkMode? 'dark' : 'light'} />
              </div>
            )}
            {activeTab === 'Code' && (
              <div>
        ...
        <div>
          <div className='relative sm:pl-5'>
                  <pre className='bg-[#18181B] p-3 rounded-md overflow-auto text-sm sm:text-base w-[350px] sm:w-[600px] border border-zinc-700'>
                    <code className='text-zinc-300'>npx @ayushmxxn/serenity-ui@latest add password-changed-form</code>
                  </pre>
                  <button
                    onClick={() => copyToClipboard('npx @ayushmxxn/serenity-ui@latest add password-changed-form', 1)}
