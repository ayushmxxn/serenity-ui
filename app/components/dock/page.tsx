...
// Source code for dock component
const sourcecode = `
/* eslint-disable react-hooks/rules-of-hooks */
"use client";
...
const ComponentShowcase: React.FC = () => {
  ...
  const copyCLI = () => {
    navigator.clipboard.writeText("npx @ayushmxxn/serenity-ui@latest add dock");
    setCopiedCode(true);
  ...
  return (
    <section className="min-h-screen bg-neutral-950 text-white pb-12 relative">
      ...
      <div className=" mx-auto py-8 px-6 sm:px-8 lg:px-12">
        <div className="mb-6">
          <h1 className="text-3xl font-semibold text-white mb-2">Dock</h1>
          <p className="text-neutral-400 text-base max-w-2xl">
            Animated Dock component with pre-built positioning setup for top,
            bottom, right, left positions of the screen.
          </p>
        </div>
