...
export default function HomepageSponsors() {
  ...
  return (
    <section
      id="sponsors"
      aria-label="Sponsors"
      className="w-full bg-[var(--bg-primary)] text-[var(--text-primary)] px-5 sm:px-8 lg:px-10 py-20 sm:py-28 border-t border-[var(--card-border)]"
    >
      <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight font-heading text-[var(--text-primary)]">
          Be the first to support Serenity.
        </h2>

        <p className="mt-3 text-sm sm:text-base text-[var(--text-muted)] max-w-md leading-relaxed">
          Serenity is free, open source, and built independently.
          Supporters will be featured right here.
        </p>
