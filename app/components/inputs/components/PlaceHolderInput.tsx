        ...
        <div className="relative w-full">
          <div className="relative w-full">
            ...
            <input
              ...
              className={\`\${GeistSans.className} w-full p-2 pr-10 pl-5 bg-zinc-800 sm:bg-zinc-900 border border-zinc-700 sm:border-zinc-800 rounded-full focus:outline-none \${
        ...
        <div className="relative w-full">
          <div className="relative w-full">
            ...
            <input
              ...
              className={`${
                GeistSans.className
              } w-full p-2 pr-10 pl-5 bg-zinc-800 sm:bg-zinc-900 border border-zinc-700 sm:border-zinc-800 rounded-full focus:outline-none ${
                isSending ? "text-transparent" : "text-neutral-100"
              }`}
              disabled={isSending}
            />
            ...
            {ripples.map((ripple, index) => (
              <motion.span
                ...
                style={{
                  ...
                  top: 0,
                  left: 0,
                  transform: `translate(${ripple.x - 28}px, ${
                    ripple.y - 28
                  }px)`,
                }}
                animate={{ scale: [0, 2], opacity: [1, 0] }}
