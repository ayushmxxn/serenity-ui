...
function TubeLightNavbarPage() {
  ...
  return (
    <div className='bg-black/80 text-white backdrop-blur-md w-full h-screen pt-24 overflow-auto p-5'>
      <span className='text-4xl font-semibold pl-1'>Tubelight Navbar</span>
      <div>
        <p className='sm:text-base mt-4 pl-1 text-gray-400 max-w-lg 2xl:max-w-xl'>Trendy and Responsive navigation bar with tabbed links and a dynamic tubelight effect.</p>
      </div>
        ...
        <div>
          <div className='relative sm:pl-5 mb-10'>
                  <pre className='bg-[#18181B] p-3 rounded-md overflow-auto text-sm sm:text-base w-[350px] sm:w-[600px] border border-zinc-700'>
                    <code className='text-zinc-300'>npx @ayushmxxn/serenity-ui@latest add tubelight-navbar</code>
                  </pre>
                  <button
                    onClick={() => copyToClipboard('npx @ayushmxxn/serenity-ui@latest add tubelight-navbar', 1)}
...
export default TubeLightNavbarPage;
