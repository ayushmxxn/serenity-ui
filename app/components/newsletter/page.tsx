                    ...
                    {!subscribed ? (
                        ...
                        >
                            ...
                            <div className='flex justify-center items-center mt-2'>
                                <button onClick={handleSubscribe} className={\`\${mode === 'dark'? 'bg-white text-black' : 'bg-black text-white'} w-80 p-2\`}>Subscribe</button>
                            </div>
                        </motion.div>
                    ) : (
                        <motion.div
          ...
          <div>
            {activeTab === 'Preview' && (
              <div className='black-grid-embed'>
                  <NewsLetter mode={darkMode? 'dark' : 'light'} />
              </div>
            )}
            {activeTab === 'Code' && (
              <div>
        ...
        <div>
          <div className='relative sm:pl-5'>
                  <pre className='bg-[#18181B] p-3 rounded-md overflow-auto text-sm sm:text-base w-[350px] sm:w-[600px] border border-zinc-700'>
                    <code className='text-zinc-300'>npx @ayushmxxn/serenity-ui@latest add newsletter</code>
                  </pre>
                  <button
                    onClick={() => copyToClipboard('npx @ayushmxxn/serenity-ui@latest add newsletter', 1)}
