...
import UsernameTestimonial from './components/UsernameTestimonial';
...
import UsernameTestimonial from './components/ui/UsernameTestimonial'
...
function page() {
  return (
    <div>
      <UsernameTestimonial mode='light' testimonials={testimonials}/>
    </div>
  )
}
...
const propsData = [
    ...
    { name: 'username', type: 'string', description: 'Specifies the username of the person' },
    { name: 'text', type: 'string', description: 'Specifies the testimonial that the person has given' },
    { name: 'social', type: 'number', description: 'Represents the URL of the social media profile'},
          ...
          <div>
            {activeTab === 'Preview' && (
              <div className='black-grid-embed'>
                  <UsernameTestimonial mode={`${darkMode? 'dark' : 'light'}`} testimonials={testimonials} />
              </div>
            )}
            {activeTab === 'Code' && (
              <div>
        ...
        <div>
          <div className='relative'>
                  <pre className='bg-zinc-900/70 backdrop-blur-lg p-3 sm:ml-4 border border-zinc-700 shadow-lg rounded-md overflow-auto text-sm sm:text-base w-[350px] sm:w-[600px]'>
                    <code className='text-zinc-300'>npx @ayushmxxn/serenity-ui@latest add username-testimonial</code>
                  </pre>
                  <button
                    onClick={() => copyToClipboard('npx @ayushmxxn/serenity-ui@latest add username-testimonial', 1)}
