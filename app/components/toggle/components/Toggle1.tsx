...
function Toggle() {
    ...
    return (
      <div className='h-screen flex justify-center items-center'>
         <div className={\`flex justify-center items-cente w-14 h-8 rounded-full \${!darkmode ? 'bg-white border border-zinc-200' : 'bg-zinc-950 border border-zinc-800'}\`}>
            <div className='flex justify-center items-center' onClick={handleToggle}>
                <span className={\`flex justify-center items-center px-1 py-1 rounded-full transition-colors duration-300 \${!darkmode ? 'bg-gray-200 text-black' : 'bg-transparent text-gray-300'}\`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
                    </svg>
                </span>
                <span className={\`flex justify-center items-center px-1 py-1 rounded-full transition-colors duration-300 \${darkmode ? 'bg-zinc-800 text-white' : 'bg-transparent text-gray-500'}\`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
