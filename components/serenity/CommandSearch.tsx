  ...
  return (
    <div>
      ...
      <div className='md:hidden sm:mr-5'>
        <MdKeyboardCommandKey onClick={handleShortcutClick} className='bg-zinc-800 rounded p-1' size={20}/>
      </div>
      {/* Search Modal */}
      {showModal &&
        (<SerenityMobileSearch showmodal={showModal} setshowmodal={setShowModal} pages={pages} />)
      }
    </div>
  )
}
